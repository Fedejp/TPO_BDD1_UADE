...
CREATE TABLE Coberturas (
    ...
    constraint cobert_pk PRIMARY KEY(IdEstudio, Sigla, NroPlan)
);
...
CREATE TABLE Afiliados(
    IdAfiliado INT, -- No lo pongo autonumérico porque se supone que es el número de carnet
    DNI INT NOT NULL,
    Sigla CHAR(2) NOT NULL,
    NroPlan SMALLINT NOT NULL,
    CONSTRAINT Afiliados_pk PRIMARY KEY (IdAfiliado, Sigla)
    --Agrego Sigla dentro de PK por si un nro de distintas Obras Sociales se repite.
